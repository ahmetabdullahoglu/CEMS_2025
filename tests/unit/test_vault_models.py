...
class TestVaultModel:
    ...
    @pytest.mark.asyncio
    async def test_create_main_vault(self, db_session):
    ...
    @pytest.mark.asyncio
    async def test_main_vault_without_branch_id(self, db_session):
    ...
    @pytest.mark.asyncio
    async def test_branch_vault_requires_branch_id(self, db_session):
    ...
    @pytest.mark.asyncio
    async def test_unique_vault_code(self, db_session):
...
class TestVaultBalanceModel:
    ...
    @pytest.mark.asyncio
    async def test_create_vault_balance(self, db_session, test_currency):
    ...
    @pytest.mark.asyncio
    async def test_balance_cannot_be_negative(self, db_session, test_currency):
    ...
    @pytest.mark.asyncio
    async def test_unique_vault_currency_combination(self, db_session, test_currency):
...
class TestVaultTransferModel:
    ...
    @pytest.mark.asyncio
    async def test_create_vault_to_vault_transfer(self, db_session, test_currency, test_user):
    ...
    @pytest.mark.asyncio
    async def test_create_vault_to_branch_transfer(self, db_session, test_currency, test_branch, test_user):
    ...
    @pytest.mark.asyncio
    async def test_transfer_amount_must_be_positive(self, db_session, test_currency, test_user):
    ...
    @pytest.mark.asyncio
    async def test_transfer_destination_check(self, db_session, test_currency, test_user):
    ...
    @pytest.mark.asyncio
    async def test_unique_transfer_number(self, db_session, test_currency, test_user):
...
class TestVaultTransferNumberGenerator:
    ...
    @pytest.mark.asyncio
    async def test_generate_first_transfer_number(self, db_session):
        """Test generating the first transfer number for a date"""
        number = await VaultTransferNumberGenerator.generate(
            db_session,
            datetime(2025, 1, 9)
        )
    ...
    @pytest.mark.asyncio
    async def test_generate_sequential_transfer_numbers(self, db_session, test_currency, test_user):
        ...
        transfer1 = VaultTransfer(
            transfer_number=await VaultTransferNumberGenerator.generate(
                db_session,
                datetime(2025, 1, 9)
            ),
            from_vault_id=vault.id,
        ...
        number2 = await VaultTransferNumberGenerator.generate(
            db_session,
            datetime(2025, 1, 9)
        )
